 ...
 *
 * <p>Testujemy przez AuthService (nie HTTP) z prawdziwa baza PostgreSQL (Testcontainers).
 * EmailService jest mockowany — nie chcemy wysylac emaili w testach. Kazdy test uzywa unikalnego
 * emaila (UUID suffix) aby uniknac konfliktow miedzy testami w tej samej bazie.
 */
@SpringBootTest
