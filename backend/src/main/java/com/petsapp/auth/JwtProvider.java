 ...
 *
 * <p>Access token zawiera userId i email jako claims — pozwala to uniknac zapytania do bazy przy
 * kazdym zadaniu. Refresh token to losowy UUID przechowywany w bazie jako hash SHA-256.
 */
@Component
public class JwtProvider {
  ...
  /**
   * Generuje losowy refresh token (UUID) i zwraca jego hash SHA-256 do zapisu w bazie.
   *
  ...
  /**
   * Sprawdza czy token jest syntaktycznie poprawny i wazny — bez rzucania wyjatkow.
   *
   * @param token JWT jako String
