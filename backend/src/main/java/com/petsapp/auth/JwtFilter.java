 ...
 *
 * <p>Czyta naglowek Authorization: Bearer {token}, weryfikuje token JWT i ustawia uwierzytelniony
 * principal w SecurityContextHolder. Nie rzuca wyjatkow — bledne tokeny sa ignorowane (Spring
