 ...
 *
 * <p>
 * username: 3-30 znakow, tylko litery, cyfry i podkreslniki. password: minimum
 * 8 znakow.
 */
public record RegisterRequest(
        ...
        @NotBlank(message = "Username is required") @Size(min = 3, max = 30, message = "Username must be between 3 and 30 characters") @Pattern(regexp = "^[a-zA-Z0-9_]+$", message = "Username may only contain letters, digits and underscores") String username,
