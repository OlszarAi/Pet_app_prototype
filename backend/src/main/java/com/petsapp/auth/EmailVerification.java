...
/**
 * Kod weryfikacji emaila wysylany przy rejestracji i na zadanie ponownego
 * wyslania.
 *
 * <p>
 * Kazdy uzytkownik moze miec wiele rekordow (np. po ponownym wyslaniu), ale
 * tylko jeden
 * nieuzywany (used_at IS NULL) jest wazny. Stare kody sa logicznie nieaktywne
 * przez expires_at.
 */
@Entity
