...
/**
 * Endpointy uwierzytelniania — rejestracja, weryfikacja emaila, logowanie,
 * refresh, logout.
 *
 * <p>
 * Controller jest odpowiedzialny wylacznie za routing i walidacje DTO. Cala
 * logika biznesowa
...
public class AuthController {
    ...
    /**
     * Wyciaga IP klienta z naglowka X-Forwarded-For (jesli jest proxy) lub
     * bezposrednio z polaczenia.
     *
