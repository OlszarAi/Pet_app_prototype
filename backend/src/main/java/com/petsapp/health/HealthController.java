 ...
 *
 * <p>GET /health — ogolny status (czy aplikacja dziala) GET /health/ready — readiness check (czy
 * aplikacja jest gotowa na ruch)
 *
 * <p>Oba endpointy sa publiczne (bez uwierzytelnienia) — uzywane przez load balancer.
 */
@RestController
