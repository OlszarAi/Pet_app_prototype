...
/**
 * Standardowy wrapper dla wszystkich odpowiedzi API.
 * Kazdy endpoint zwraca ApiResponse zamiast surowego obiektu.
 *
 * Sukces:  {"success": true,  "data": {...}}
 * Blad:    {"success": false, "error": {...}}
 * Lista:   {"success": true,  "data": [...], "pagination": {...}}
 */
...
public record ApiResponse<T>(
    ...
    /**
     * Szczegoly bledu zwracane do klienta.
     * fields jest opcjonalne — tylko przy VALIDATION_ERROR.
     */
    @JsonInclude(JsonInclude.Include.NON_NULL)
